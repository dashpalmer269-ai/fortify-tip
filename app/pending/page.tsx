          ...
          <Card className="mb-8">
            <CardBody>
              ...
              <ul className="space-y-3 text-sm text-[var(--color-secondary)]">
                <Step>Make sure your admin knows to check Fortify &rarr; Team for new requests.</Step>
                <Step>Watch your inbox for the confirmation email &mdash; it goes out automatically.</Step>
